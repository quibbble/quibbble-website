          ...
          <div className="flex flex-col items-center max-w-[56rem]">
            <div className="mt-4 md:mt-8 bg-dark-900 p-8 rounded-3xl w-full flex flex-col items-center shadow-md opacity-0 animate-fade animation-delay-[50ms] fill-mode-forwards">
              <div className="w-full flex flex-col items-center">
                <h1 className="text-yellow font-lobster text-4xl">Welcome In</h1>
                <p className="mt-2 text-white font-light">Already have an account? <Link to={"/login"} className="font-bold underline">Login</Link></p>
              </div>
              <div className="mt-12 md:w-96 flex flex-col items-center">
                ...
                <div className="relative w-full mt-4">
                  <FaLock className="absolute h-4 w-4 top-[50%] left-4 box-border translate-y-[-50%] fill-gray opacity-50" />
                  <input type="password" className="w-full bg-dark-600 pl-9 py-2 rounded-full focus:outline focus:outline-2 outline-yellow text-slate placeholder-gray" placeholder="retype password" />
                </div>
                <button className="mt-4 w-full p-2 rounded-full font-lobster bg-yellow text-xl">Sign Up</button>
              </div>
