    ...
    return (
      <div className="flex items-center justify-center w-full h-screen">
        <div className="flex flex-col items-center justify-center w-full h-screen opacity-0 animate-fade fill-mode-forwards">
            <div className="flex flex-col items-center justify-center px-8 py-12 m-4 bg-dark-900 rounded-3xl">
                <h1 className={`max-w-96 text-white mb-6 text-4xl drop-shadow-m font-lobster`}>Welcome to quibbble.com!</h1>
                <h1 className={`max-w-96 text-white mb-4 text-xl drop-shadow-m`}>Please read and agree to our <a target="_blank" href="/terms-of-service" className="font-bold underline text-yellow">terms of service</a> and <a target="_blank" href="/privacy-policy" className="font-bold underline text-yellow">privacy policy</a> to enter.</h1>
                <div onClick={() => agreed()} className="flex items-center justify-center mt-4 font-bold cursor-pointer group">
                    <p className="ml-1 transition duration-500 ease-in-out text-slate group-hover:text-yellow">agree and enter</p>
