    ...
    return (
        game.online ? 
            <div className="flex w-full h-screen">
                <div className='flex flex-col w-full m-2 opacity-0 md:flex-row md:grow lg:m-4 animate-fade fill-mode-forwards'>
                    <div ref={ ref } className='relative w-full p-4 mb-2 mr-0 bg-dark-900 grow md:h-full rounded-3xl md:mb-0 md:mr-2 lg:mr-4 mg:p-8'>
                        <div className='absolute z-50 top-4 md:top-auto md:bottom-8 left-4 md:left-6'>
            ...
            <div className="flex flex-col items-center justify-center w-full h-screen opacity-0 animate-fade fill-mode-forwards">
                <div className="flex flex-col items-center justify-center p-8 bg-dark-900 rounded-3xl">
                    ...
                    <Link className="flex items-center justify-center mt-4 font-bold group" to={`/games/${ gameKey }`} state={{ from: location.pathname }} >
                        <svg className="ml-2 transition duration-500 ease-in-out fill-slate group-hover:-translate-x-2" width="19" height="16" viewBox="0 0 19 16" fill="none" xmlns="http://www.w3.org/2000/svg">
