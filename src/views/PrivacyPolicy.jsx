    ...
    return (
        <div className="w-full flex items-center justify-center m-12">
            <article className="prose">
                ...
                <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at https://quibbble.com, unless otherwise defined in this Privacy Policy.</p>
